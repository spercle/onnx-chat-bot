...
export class LLM {
  ...
  async load(model, options) {
    ...
    const model_path = local ? "./model" : model.path;
    let model_file = hasFP16 ? "model_q4f16.onnx" : "model_q4.onnx";
    ...
    const externaldata = model.externaldata ? await fetchAndCache(`${model_path}/${model_file}_data`) : false;
